...
| **Прозрачность**        | Игрок видит модификаторы в интерфейсе                   | 🔄 Требуется реализация |

---

> 💡 **Рекомендация для интерфейса**:
> Добавить подсказки при наведении на игрока:  
> *«Константин: любимый цвет → ваши синие карты дадут доход только ему, а красные украдут в 2× больше»*
